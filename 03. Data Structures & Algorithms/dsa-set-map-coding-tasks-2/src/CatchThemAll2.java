...
//        }
        ...
        if (!pokemonsByType.get(type).isEmpty() && pokemonsByType.containsKey(type) && pokemonsByType.get(type) != null) {

            String sortedByNameAndPower = pokemonsByType
                    .get(type)
                    .stream()
                    .limit(5)
            ...
            sbResult.append(sortedByNameAndPower);
        }
