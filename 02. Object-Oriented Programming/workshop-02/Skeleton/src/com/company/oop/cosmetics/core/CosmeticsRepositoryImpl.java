...
public class CosmeticsRepositoryImpl implements CosmeticsRepository {
    ...
    public ShampooImpl createShampoo(String name, String brandName, double price, GenderType genderType,
        ...
        ShampooImpl newShampoo = new ShampooImpl(name, brandName, price, genderType, millilitres, usageType);
        this.products.add(newShampoo);

        return newShampoo;
    }

    @Override
    public ToothpasteImpl createToothpaste(String name, String brandName, double price, GenderType genderType,
                                           List<String> ingredients) {

        ToothpasteImpl newToothpaste = new ToothpasteImpl(name, brandName, price, genderType, ingredients);
    ...
    @Override
    public CreamImpl createCream(String name, String brandName, double price, GenderType genderType,
                                 ScentType scentType) {
        CreamImpl newCream = new CreamImpl(name, brandName, price, genderType, scentType);
